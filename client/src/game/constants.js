...
export const PIECE_TYPES = ['general', 'advisor', 'elephant', 'horse', 'chariot', 'cannon', 'pawn'];
...
export function inTerritory(row, color) {
  return color === 'red' ? row >= 5 : row <= 4;
}

export function crossedRiver(row, color) {
